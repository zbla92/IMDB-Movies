    ...
    <div className='footer'>
      <div className='footer__container'>
        <div className='footer__links footer__links--left'>
          <div className='footer__dependencies'>
            ...
            >
              <img src={reactIco} alt='icon' width='15px' /> React
            </a>
            <a
            ...
            >
              <img src={reduxIco} width='15px' alt='icon' /> Redux
            </a>
            <a
              href='https://bulma.io/'
              target='_blank'
            ...
            >
              <img src={bulmaIco} width='11px' alt='icon' /> Bulma
            </a>
            <a
              ...
              className='footer__icon footer__icon--popcorn'
            >
              <img src={heroku} width='14px' alt='icon' /> Heroku
            </a>
          </div>
        </div>
        <div className='footer__links--right'>
          <div className='footer__dependencies'>
            <a
              ...
              className='footer__icon footer__icon--netflix'
            >
              <img src={netflix} width='15px' alt='icon' /> Netflix
            </a>
            <a
              href='http://hbo.com'
              target='_blank'
              ...
              className='footer__icon footer__icon--hbo'
            >
              <img src={hboIco} width='30px' alt='icon' /> TV
            </a>
            <a
              ...
              className='footer__icon footer__icon--popcorn'
            >
              <img src={popcornTime} width='13px' alt='icon' /> &nbsp;Popcorn
              Time
            </a>
          </div>
        </div>
      ...
      <div className='footer__sentance'>
        <span className='footer__sentance__span'>
          This application was built for skill presentaton purpose only. Feel
          free to check out my github account{' '}
          <a href='http://github.com/zbla92'>here</a>
        </span>
      </div>
    </div>
  );
